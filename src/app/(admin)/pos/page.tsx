            ...
            <div className="p-6 flex flex-col gap-6">
                ...
                <div className="min-h-[140px] flex items-center justify-center p-4 bg-slate-50 rounded-xl border border-slate-100 relative overflow-hidden">
                    ...
                    {paymentMethod === 'VIETQR' && (() => {
                        ...
                        const qrUrl = `https://img.vietqr.io/image/${bankSettings.bank_code}-${bankSettings.account_number}-compact2.png?amount=${Math.round(grandTotal)}&addInfo=${encodeURIComponent(note)}&accountName=${encodeURIComponent(bankSettings.account_name)}`;
                        return (
